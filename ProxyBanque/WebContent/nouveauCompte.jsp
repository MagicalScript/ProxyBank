            ...
            <div class="col-6">
	            <c:choose>
				    <c:when test="${empty param.compteId}">
					    <form action="nouveauCompte" method="post">
					        <div class="form-group">
		                        ...
		                        <input type="text" name="libelle" id="" class="form-control" placeholder="Libellé du compte"
		                            aria-describedby="helpId" required>
		                        <small id="helpId" class="text-muted">Libellé du compte</small>
		                    </div>
		                    <div class="form-group">
				    ...
				    <form action="clientInfo?action=modifier&compteId=${param.compteId}" method="post">
				        <div class="form-group">
	                        <label for="libelle">Libellé du compte</label>
	                        <input type="text" name="libelle" id="" value="${param.libelle }"  class="form-control" placeholder="Libellé du compte"
