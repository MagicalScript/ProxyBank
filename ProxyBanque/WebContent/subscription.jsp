...
<body>
    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-6">
            	<c:if test="${!empty errorProfile}">
            	 <div class="border-danger table-bordered rounded p-2 mb-3">
                    il y a deja un Admin.
                    Choisessey un auther profile.
                </div>
                </c:if>
                <form action="subscription" method="post">
                    <div class="form-group">
                        <label for="nom">Nom</label>
                        <input type="text" name="nom" id="" class="form-control" placeholder="Entre votre Email"
                            aria-describedby="helpId" required >
                        <small id="helpId" class="text-muted">Entre votre Email</small>
                    </div>
                    <div class="form-group">
                        <label for="prenom">Prenom</label>
                        <input type="text" name="prenom" id="" class="form-control" placeholder="Entre votre Email"
                            aria-describedby="helpId" required >
                        <small id="helpId" class="text-muted">Entre votre Email</small>
                    </div>
                    <div class="input-group pb-2">
                        ...
                        <div class="form-check ml-3">
                            <label class="form-check-label">
                                <input type="radio" class="form-check-input" name="profile" id="profile"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="email" id="" class="form-control" placeholder="Entre votre Email"
                            aria-describedby="helpId" required >
                        <small id="helpId" class="text-muted">Entre votre Email</small>
                    </div>
                    <div class="form-group">
                        ...
                        <input type="password" name="pwd" id="" class="form-control"
                            placeholder="Entre votre mots de pass" aria-describedby="helpId" required >
                        <small id="helpId" class="text-muted">Entre votre mots de pass</small>
                    </div>
